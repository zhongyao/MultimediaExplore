...
public class FileUtil {
    ...
    public static String getFilePath() {
        String fileDir = AudioRecordManager.getInstance().getCurrentConfig().getRecordDir();
        ...
        return String.format(Locale.getDefault(), "%s%s%s", fileDir, fileName, AudioRecordManager.getInstance().getCurrentConfig().getFormat().getExtension());
    }
